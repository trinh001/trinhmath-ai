...
def run_dry_match(store, data_dir: Path, trinhmath_dir: Path | None = None) -> tuple[list[dict], dict]:
    ...
    report = {"total_parser_drafts": len(outcomes), "matched_high_confidence": 0, "matched_medium_confidence": 0, "matched_low_confidence": 0, "no_match": 0, "ambiguous_match": 0, "auto_approve_candidates": 0, "review_required": 0, "duplicates": 0, "validation_failed": 0}
